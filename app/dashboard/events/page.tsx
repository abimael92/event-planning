                ...
                <DashboardLayout>
                    ...
                    <div className="relative overflow-hidden rounded-lg md:rounded-xl p-4 md:p-6 lg:p-8 w-full animate-gradient-shift">
                        <div className="relative z-10 text-white w-full">
                            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 animate-in fade-in-50 slide-in-from-bottom-3 duration-500">
                                <div className=" gap-2">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                            {[
                                ...
                                <div key={stat.label} className="animate-in fade-in-50 slide-in-from-bottom-3 duration-300">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            {filteredEvents.map((event, index) => (
                                <div key={event.id} className="animate-in fade-in-50 slide-in-from-bottom-3 duration-300">
